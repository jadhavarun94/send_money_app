...
// in send_money_app_assignment/test/transaction_history_test.dart.
...
class MockTransactionRepository extends _i1.Mock
  ...
  @override
  _i3.Future<List<Map<String, dynamic>>> getTransactions() =>
      (super.noSuchMethod(
        Invocation.method(
          #getTransactions,
          [],
  ...
  @override
  _i3.Future<void> saveTransaction(Map<String, dynamic>? transaction) =>
      (super.noSuchMethod(
        Invocation.method(
          #saveTransaction,
          [transaction],
